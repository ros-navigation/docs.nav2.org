...
+--------------------------------+------------------------+----------------------------------+
| `Inflation Layer Legacy`_      | Eitan Marder-Eppstein  | Inflates lethal obstacles in     |
|                                |                        | costmap with exponential decay   |
+--------------------------------+------------------------+----------------------------------+
...
.. _Inflation Layer Legacy: https://github.com/ros-navigation/navigation2/tree/main/nav2_costmap_2d/plugins/legacy_inflation_layer.cpp
