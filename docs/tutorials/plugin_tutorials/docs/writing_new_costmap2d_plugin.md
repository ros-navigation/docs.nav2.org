...
<figure markdown="span">
  ![Animated gif with gradient demo](images/Writing_new_Costmap2D_plugin/gradient_layer_preview.gif){ width="700px" title="Animated gif with gradient demo" }
</figure>
...
<figure markdown="span">
  ![Image of gradient costmap used](images/Writing_new_Costmap2D_plugin/gradient_layer_run.png){ width="700px" title="Image of gradient costmap used" }
</figure>
