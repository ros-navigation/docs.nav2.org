...
<figure markdown="span">
  ![Animated gif of pure pursuit controller demo](images/Writing_new_nav2controller_plugin/nav2_pure_pursuit_gif.gif){ width="640px" title="Animated gif of pure pursuit controller demo" }
</figure>
...
!!! note
    ...
    This tutorial is based on a previously existing simplified version of the Regulated Pure Pursuit controller now in the Nav2 stack.
