...
Before completing this tutorial, completing the [Getting Started](../../getting_started/index.md#getting-started) is highly recommended especially if you are new to ROS and Navigation2.
