<a id="collision-monitor-tutorial"></a>
...
![image](tutorials/docs/images/Collision_Monitor/collision_monitor.gif)
...
Please make sure that Nav2 project is also built locally as it was made in [Build and Install](../../development_guides/build_docs/index.md#build-instructions).
...
![image](tutorials/docs/images/Collision_Monitor/polygons.png)
...
![image](tutorials/docs/images/Collision_Monitor/dexory_velocity_polygon.gif)
...
![image](tutorials/docs/images/Collision_Monitor/holonomic_direction.png)

Below shows some common configurations for holonomic robots that cover multiple directions of the resultant velocity:

![image](tutorials/docs/images/Collision_Monitor/holonomic_examples.png)
```yaml
collision_monitor:
  ros__parameters:
    base_frame_id: "base_footprint"
...
![image](tutorials/docs/images/Collision_Monitor/polygons_visualization.png)
...
![image](tutorials/docs/images/Collision_Monitor/collision.png)
