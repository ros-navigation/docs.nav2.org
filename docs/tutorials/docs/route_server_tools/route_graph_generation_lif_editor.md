...
<figure markdown="span">
  ![](../images/route_graph_generation_lif_editor/delete_node.png){ width="710px" height="330px" }
</figure>
...
<figure markdown="span">
  ![](../images/route_graph_generation_lif_editor/delete_edge.png){ width="710px" height="330px" }
</figure>
...
<figure markdown="span">
  ![](../images/route_graph_generation_lif_editor/check_geojson.png){ width="710px" height="330px" }
</figure>

<figure markdown="span">
  ![](../images/route_graph_generation_lif_editor/check_geojson_1.png){ width="710px" height="330px" }
</figure>
...
<figure markdown="span">
  ![](../images/route_graph_generation_lif_editor/export_geojson.png){ width="710px" height="330px" }
</figure>
