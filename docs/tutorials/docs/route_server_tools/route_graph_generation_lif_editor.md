...
- Website: [https://vda5050-lif-editor.vercel.app/](https://vda5050-lif-editor.vercel.app/)
- Github: [https://github.com/bekirbostanci/vda5050_lif_editor](https://github.com/bekirbostanci/vda5050_lif_editor)
...
<br/>
![image](tutorials/docs/images/route_graph_generation_lif_editor/frame_name.png)
<br/>
...
<br/>
![image](tutorials/docs/images/route_graph_generation_lif_editor/setup_coordinate_system.png)
<br/>
...
<br/>
![image](tutorials/docs/images/route_graph_generation_lif_editor/add_node.png)
<br/>
...
<br/>
![image](tutorials/docs/images/route_graph_generation_lif_editor/delete_node.png)
<br/>
...
<br/>
![image](tutorials/docs/images/route_graph_generation_lif_editor/add_edge_normal.png)
<br/>
1. If the **‘Fast Create’** toggle is on, clicking on the map will automatically connect the new node to the previously selected node.

<br/>
![image](tutorials/docs/images/route_graph_generation_lif_editor/add_edge_fast_create.png)
<br/>
...
<br/>
![image](tutorials/docs/images/route_graph_generation_lif_editor/delete_edge.png)
<br/>
...
<br/>
![image](tutorials/docs/images/route_graph_generation_lif_editor/check_geojson.png)
<br/>
![image](tutorials/docs/images/route_graph_generation_lif_editor/check_geojson_1.png)
<br/>
...
<br/>
![image](tutorials/docs/images/route_graph_generation_lif_editor/export_geojson.png)
<br/>
