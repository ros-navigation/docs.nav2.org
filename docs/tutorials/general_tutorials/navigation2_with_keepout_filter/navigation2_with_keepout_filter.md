...
<figure markdown="span">
  ![](images/drawing_keepout_mask.png){ width="500px" }
</figure>
...
<figure markdown="span">
  ![](images/keepout_global.png){ height="400px" }
</figure>

!!! note

    For another example and additional context, check the Nav2 tutorials [https://github.com/ros-navigation/navigation2_tutorials/tree/jazzy/nav2_costmap_filters_demo](https://github.com/ros-navigation/navigation2_tutorials/tree/jazzy/nav2_costmap_filters_demo)
