...
The code for this tutorial is hosted in the [nav2_semantic_segmentation_demo](https://github.com/ros-navigation/navigation2_tutorials/tree/lyrical/nav2_semantic_segmentation_demo) directory. It's highly recommended that you clone and build these packages when setting up your development environment.
...
Everything is already set up in the [nav2_semantic_segmentation_demo](https://github.com/ros-navigation/navigation2_tutorials/tree/lyrical/nav2_semantic_segmentation_demo) directory, so clone the repo and build it if you haven't already:
...
### 3. Configure Nav2 with Semantic Segmentation Layer
