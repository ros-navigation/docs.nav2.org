...
<figure markdown="span">
  ![3Laws Robotics Stack](assets/3laws_stack.svg){ title="3Laws Robotics Stack" }
</figure>
...
<figure markdown="span">
  ![Supervisor Solution Infographic](assets/solution_infographic.png){ title="Supervisor Solution Infographic" }
</figure>
...
<figure markdown="span">
  ![Nav2 and 3Laws Supervisor Integration Diagram](assets/nav2_diagram_3laws.png){ title="Nav2 and 3Laws Supervisor Integration Diagram" }
</figure>
...
<figure markdown="span">
  ![3Laws AMR demo](assets/3laws_amr2.gif){ width="100%" title="3Laws AMR demo" }
</figure>
...
<figure markdown="span">
  ![Supervisor Control Panel Page 1](assets/page1.png){ title="Supervisor Control Panel Page 1" }
</figure>
...
<figure markdown="span">
  ![Supervisor Robot Model Configuration](assets/kinematics_perception.svg){ title="Supervisor Robot Model Configuration" }
</figure>
...
<figure markdown="span">
  ![Supervisor Robot Model Configuration](assets/page2.png){ title="Supervisor Robot Model Configuration" }
</figure>
...
<figure markdown="span">
  ![Supervisor Localization Configuration](assets/page3.png){ title="Supervisor Localization Configuration" }
</figure>
...
<figure markdown="span">
  ![Supervisor Perception Configuration](assets/page4.png){ title="Supervisor Perception Configuration" }
</figure>
...
<figure markdown="span">
  ![Supervisor System Configuration](assets/page6.png){ title="Supervisor System Configuration" }
</figure>
