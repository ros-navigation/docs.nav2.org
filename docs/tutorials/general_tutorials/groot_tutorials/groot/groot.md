...
<figure markdown="span" id="groot-nav2-default-bt">
  ![](assets/bt_w_replanning_and_recovery.png)
...
<figure markdown="span" id="groot-create-custom-node">
  ![](assets/groot_create_custom_node.png)
...
You can see more examples in [Nav2's BT Node Palette XML](https://github.com/ros-navigation/navigation2/blob/lyrical/nav2_behavior_tree/nav2_tree_nodes.xml).
