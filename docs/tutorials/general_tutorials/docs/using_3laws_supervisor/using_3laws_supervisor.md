...
<figure markdown="span">
  ![Supervisor Solution Infographic](images/solution_infographic.png){ title="Supervisor Solution Infographic" }
</figure>
...
<figure markdown="span">
  ![Supervisor Control Panel Page 1](images/page1.png){ title="Supervisor Control Panel Page 1" }
</figure>
...
<figure markdown="span">
  ![Supervisor Robot Model Configuration](images/kinematics_perception.svg){ title="Supervisor Robot Model Configuration" }
</figure>
...
<figure markdown="span">
  ![Supervisor Robot Model Configuration](images/page2.png){ title="Supervisor Robot Model Configuration" }
</figure>
...
<figure markdown="span">
  ![Supervisor Localization Configuration](images/page3.png){ title="Supervisor Localization Configuration" }
</figure>
...
<figure markdown="span">
  ![Supervisor Perception Configuration](images/page4.png){ title="Supervisor Perception Configuration" }
</figure>
...
<figure markdown="span">
  ![Supervisor System Configuration](images/page6.png){ title="Supervisor System Configuration" }
</figure>
