...
Follow [https://github.com/nvidia-isaac/SWAGGER/](https://github.com/nvidia-isaac/SWAGGER/) to install SWAGGER using the installation instructions in the README.
