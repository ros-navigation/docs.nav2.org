...
<div markdown="span" class="flex-images">
	![](images/groot_bt_editor.png)
	![](images/groot_with_nav2_custom_nodes.png)
</div>
...
<figure markdown="span">
  ![](images/editing_bt.png){ width="80%" }
</figure>
...
<figure markdown="span">
  ![](images/groot_create_custom_node.png){ width="40%" }
</figure>

This should load a new window, as shown in the next image.

<figure markdown="span">
  ![](images/groot_interactive_node_creation.png){ width="50%" }
</figure>
...
<figure markdown="span">
  ![](images/groot_new_node.png){ width="35%" }
</figure>
...
<div markdown="span" class="flex-images">
	![](images/groot_export_button.png)
	![](images/groot_export_page.png)
</div>
