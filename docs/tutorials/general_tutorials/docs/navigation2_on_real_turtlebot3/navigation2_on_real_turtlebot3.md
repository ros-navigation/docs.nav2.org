...
<div markdown="span" class="flex-images">
	![](images/rviz_after_launch_view.png)
	![](images/rviz_slam_map_view.png)
</div>
...
<figure markdown="span">
  ![Set initial pose in RViz](images/rviz_set_initial_pose.png){ width="700px" title="Set initial pose in RViz" }
</figure>
...
<figure markdown="span">
  ![Send goal pose in RViz](images/rviz_send_goal.png){ width="700px" title="Send goal pose in RViz" }
</figure>

Once you define the target pose,  Nav2 will find a global path and start navigating the robot on the map.

<figure markdown="span">
  ![Robot navigating in RViz](images/rviz_robot_navigating.png){ width="700px" title="Robot navigating in RViz" }
</figure>
