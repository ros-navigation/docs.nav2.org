<a id="behavior-tree-follow-point"></a>
...
In this tree, we replan at 1 hz just as we did in [Navigate To Pose](nav_to_pose_recovery.md#behavior-tree-nav-to-pose) using the `ComputePathToPose` node.
