...
![Our Sponsors](images/sponsors_oct_2025.png)
...
![Navigation2 Block Diagram](images/nav2_architecture.png)
...
| <div style="text-align: center;"><br/>  <div style="margin-bottom: 20px;"><span style="font-size: 20px; font-weight: bold;">Rolling Ridley</span></div><br/>  <div style="margin-bottom: 20px;"><span style="background-color: #007bff; color: white; padding: 12px 24px; border-radius: 25px; font-size: 15px; font-weight: bold;">Development</span></div><br/></div>![image](distro_graphics/rolling.png)   | <div style="text-align: center;"><br/>  <div style="margin-bottom: 20px;"><span style="font-size: 20px; font-weight: bold;">Kilted Kaiju</span></div><br/>  <div style="margin-bottom: 20px;"><span style="background-color: #28a745; color: white; padding: 12px 24px; border-radius: 25px; font-size: 15px; font-weight: bold;">Active Support</span></div><br/></div>![image](distro_graphics/kilted.png)       |
|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <div style="text-align: center;"><br/>  <div style="margin-bottom: 20px;"><span style="font-size: 20px; font-weight: bold;">Jazzy Jalisco</span></div><br/>  <div style="margin-bottom: 20px;"><span style="background-color: #28a745; color: white; padding: 12px 24px; border-radius: 25px; font-size: 15px; font-weight: bold;">Active Support</span></div><br/></div>![image](distro_graphics/Jazzy.png)   | <div style="text-align: center;"><br/>  <div style="margin-bottom: 20px;"><span style="font-size: 20px; font-weight: bold;">Iron Irwini</span></div><br/>  <div style="margin-bottom: 20px;"><span style="background-color: #dc3545; color: white; padding: 12px 24px; border-radius: 25px; font-size: 15px; font-weight: bold;">End of Life</span></div><br/></div>![image](distro_graphics/iron.png)             |
| <div style="text-align: center;"><br/>  <div style="margin-bottom: 20px;"><span style="font-size: 20px; font-weight: bold;">Humble Hawksbill</span></div><br/>  <div style="margin-bottom: 20px;"><span style="background-color: #ffc107; color: black; padding: 12px 24px; border-radius: 25px; font-size: 15px; font-weight: bold;">Maintained</span></div><br/></div>![image](distro_graphics/humble.png)   | <div style="text-align: center;"><br/>  <div style="margin-bottom: 20px;"><span style="font-size: 20px; font-weight: bold;">Galactic Geochelone</span></div><br/>  <div style="margin-bottom: 20px;"><span style="background-color: #dc3545; color: white; padding: 12px 24px; border-radius: 25px; font-size: 15px; font-weight: bold;">End of Life</span></div><br/></div>![image](distro_graphics/galactic.png) |
