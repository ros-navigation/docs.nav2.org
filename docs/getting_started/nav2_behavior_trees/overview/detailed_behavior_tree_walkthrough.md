...
<figure markdown="span">
  ![](../images/walkthrough/overall_bt.png)
</figure>
...
<figure markdown="span">
  ![](../images/walkthrough/overall_bt_w_breakdown.png)
</figure>

The `Navigation` subtree mainly involves actual navigation behavior:

- selecting planners and controllers plugins
- calculating a path
- following a path
...
<figure markdown="span">
  ![](../images/walkthrough/navigation_subtree_bare.png)
</figure>
...
<figure markdown="span">
  ![](../images/walkthrough/contextual_recoveries.png)
</figure>
...
This subtree also utilizes the `PlannerSelector` and `ControllerSelector` nodes. These nodes offer flexibility for applications that need to adjust navigation behavior on the fly.
...
<figure markdown="span">
  ![](../images/walkthrough/recovery_subtree.png)
</figure>
