...
The full list of custom BT nodes can be found in the [nav2_behavior_tree plugins folder](https://github.com/ros-navigation/navigation2/tree/jazzy/nav2_behavior_tree/plugins).
