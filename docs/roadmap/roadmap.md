...
For a full list of important completed changes in the project, see the Migration Guides [Migration Guides](../migration/index.md#migration).
...
| [Move Development<br/>from Master to Rolling](https://github.com/ros-navigation/navigation2/issues/2337) | Small (DONE)   |
