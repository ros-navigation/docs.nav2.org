...
We follow the [ROS 2 Guidelines for AI Assisted Contributions](https://discourse.openrobotics.org/t/guidelines-for-ai-assisted-contributions-in-the-ros-project/55903) with the additional policy item: Trust must be earned through discussions, repeated contributions, and participation in the community. If an AI-centric contribution from an author without a track record appears to maintainers to be architecturally problematic, complex, or impact sensitive portions of the codebase without demonstrated knowledge of the area, a maintainer may close a contribution without further review. Key engineering decisions must be made by trusted developers and not left in the hands of AI without expert supervision.
