...
| isTaskComplete()                                                                                               | Checks if task is complete yet, times out at `100ms`. Returns<br/>`True` if completed and `False` if still going.                                                                                                         |
