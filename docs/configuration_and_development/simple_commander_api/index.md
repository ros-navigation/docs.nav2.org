...
| spin(spin_dist=1.57,<br/>time_allowance=10)                                                                    | Requests the robot to performs an in-place rotation by a given angle.                                                                                                                                                     |
| driveOnHeading(dist=0.15,<br/>speed=0.025, time_allowance=10)                                                  | Requests the robot to drive on heading by a given distance.                                                                                                                                                               |
| backup(backup_dist=0.15,<br/>backup_speed=0.025, time_allowance=10)                                            | Requests the robot to back up by a given distance.                                                                                                                                                                        |
