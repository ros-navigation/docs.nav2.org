...
<div markdown="span" class="flex-images">
  ![](assets/base_bot_1.png)
  ![](assets/base_bot_2.png)
</div>
...
!!! info "See also"
    ...
    For more information regarding the launch system in ROS 2, you can have a look at the official [ROS 2 Launch System Documentation](https://docs.ros.org/en/lyrical/Tutorials/Intermediate/Launch/Launch-system.html)
