...
To be able to follow the rest of this section, make sure that you have properly installed Gazebo. You can follow the instructions at the [Setup and Prerequisites][gazebo-classic-setup-and-prerequisites] of the previous tutorial to setup Gazebo.

### Adding Gazebo Plugins to a URDF

Let us first add a lidar sensor to `sam_bot`. Open the URDF file, [src/description/sam_bot_description.urdf](https://github.com/ros-navigation/navigation2_tutorials/blob/humble/sam_bot_description/src/description/sam_bot_description.urdf) and paste the following lines before the `</robot>` tag.
...
<figure markdown="span">
  ![](assets/add_topic_laserscan.png){ width="400" }
</figure>
...
<figure markdown="span">
  ![](assets/demo_laserscan_rviz.png)
</figure>
...
<figure markdown="span">
  ![](assets/add_topic_image_pointcloud2.png)
</figure>
