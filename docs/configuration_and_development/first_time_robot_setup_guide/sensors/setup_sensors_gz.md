...
To be able to follow the rest of this section, make sure that you have properly installed Gazebo. You can follow the instructions at the [Setup and Prerequisites](/setup_guides/odom/setup_odom_gz.md#setup-and-prerequisites) of the previous tutorial to setup Gazebo.
