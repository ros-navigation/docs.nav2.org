...
The [nav2_behavior_tree](https://github.com/ros-navigation/navigation2/tree/jazzy/nav2_behavior_tree) package provides several navigation-specific nodes that are pre-registered and can be included in Behavior Trees.
