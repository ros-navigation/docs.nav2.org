...
Source code on [Github](https://github.com/ros-navigation/navigation2/tree/jazzy/nav2_mppi_controller).
...
Type: `double` Default: `-0.35`

:   Maximum reverse velocity (m/s).

### **`wz_max`**

Type: `double` Default: `1.9`
