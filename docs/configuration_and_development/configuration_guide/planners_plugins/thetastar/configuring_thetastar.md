...
<!-- The source code and README with design, explanations, metrics and usage tips can be found on [Github][].
[Github]: https://github.com/ros-navigation/navigation2/tree/lyrical/nav2_theta_star_planner -->
...
<figure markdown="span">
  ![Path generated by the Theta* planner](assets/00-37.png){ width="640px" title="Path generated by the Theta* planner" }
</figure>
