...
[Moveit](https://moveit.ros.org/) has long has a QT [configuration assistant](http://docs.ros.org/kinetic/api/moveit_tutorials/html/doc/setup_assistant/setup_assistant_tutorial.html). This setup assistant helps the user configure their UDRF and needs to setup MoveIt configuration files.
...
- [Original github issue page](https://github.com/ros-navigation/navigation2/issues/1721)
