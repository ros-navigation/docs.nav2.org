...
![image](configuration/packages/images/constrained_smoother/constrained_smoother.png)
...
* **w_cost_cusp_multiplier:**
  ...
  : Option to use higher weight during forward/reverse direction change, helping optimizer to converge or add an extra obstacle avoidance at these problematic segments.
    ...
    ![image](configuration/packages/images/constrained_smoother/w_cost_cusp_multiplier.png)
* **cusp_zone_length:**
  | Type   |   Default |
  |--------|-----------|
  | double |       2.5 |
...
* **cost_check_points:**
  ...
  : Points in robot frame to grab costmap values from. Format: [x1, y1, weight1, x2, y2, weight2, …].
    ...
    ![image](configuration/packages/images/constrained_smoother/cost_check_points.png)
