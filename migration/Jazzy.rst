...
In `PR #4561 <https://github.com/ros-navigation/navigation2/pull/4561>` a map_vis_z parameter has been introduced to Costmap2DROS to help modify the map slightly below the default plane, aiming to eliminate flickering issues.
